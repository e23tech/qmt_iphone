...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [self setupWindowRootView];
    [self afterSetupWindow];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"quanmeiti" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"quanmeiti.sqlite"];
...
- (void) setupWindowRootView
{
    ...
    [latestController release];
    [navLatestController release];
    [latestTabbarItem release];
    ...
    [navCategoryController release];
    [categoryTabbarItem release];
    ...
    [navArticleController release];
    [articleListTabbarItem release];

    
//    TestViewController *testController = [[TestViewController alloc] init];
//    testController.title = @"测试频道";
//    UITabBarItem *testTabbarItem = [[UITabBarItem alloc] initWithTitle:@"测试" image:[UIImage imageNamed:@"duanzi.png"] tag:999];
//    testController.tabBarItem = testTabbarItem;
//    [controllers addObject:testController];
//    [testController release];
//    [testTabbarItem release];
    
    QRootElement *moreRootElement = [CDQDRootElementBuilder createMoreSettingRoot];
    
    UITabBarItem *moreTabbarItem = [[UITabBarItem alloc] initWithTabBarSystemItem:UITabBarSystemItemMore tag:40];
    UINavigationController *navMoreController = [MoreViewController controllerWithNavigationForRoot:moreRootElement];
    navMoreController.tabBarItem = moreTabbarItem;
    [controllers addObject:navMoreController];
